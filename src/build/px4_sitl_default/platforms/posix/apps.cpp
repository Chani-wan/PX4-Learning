...
int offboard_ctrl_main(int argc, char *argv[]);
int uorb_person_main(int argc, char *argv[]);
int px4_mavlink_debug_main(int argc, char *argv[]);
int px4_simple_app_main(int argc, char *argv[]);
int sched_workitem_main(int argc, char *argv[]);
int trif_posctrl_main(int argc, char *argv[]);
...
void init_app_map(apps_map_type &apps)
{
	...
	apps["offboard_ctrl"] = offboard_ctrl_main;
	apps["uorb_person"] = uorb_person_main;
	apps["px4_mavlink_debug"] = px4_mavlink_debug_main;
	apps["px4_simple_app"] = px4_simple_app_main;
	apps["sched_workitem"] = sched_workitem_main;
	apps["trif_posctrl"] = trif_posctrl_main;
