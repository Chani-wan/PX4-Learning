...
class RemoteControl: public px4::ScheduledWorkItem  {
private:
	...
	void Run() override {
		...
		if(_vehicle_local_position_sub.updated())
		{
			...
			if(_count && _input_rc.values[5] < 1600)
			{
				act_req(1);
				_count = 0;
			}
...
public:
	RemoteControl(): px4::ScheduledWorkItem(MODULE_NAME, px4::wq_configurations::lp_default) {}
	void Init() {
